...
<p align="left">
  I'm <strong>Dandy</strong>, a frontend-focused Web Developer from Germany.<br/>
  I enjoy building clean, performant user interfaces and modern web applications.
</p>
...
<div align="center">
  <img
    src="https://www.americar.de/thumbs/img/News/81/62/00/p/p_normal/colt-seavers-ist-zurueck-ein-colt-fuer-alle-faelle-kommt-als-remake-6281.jpg"
    height="420"
    alt="Colt Seavers"
  />
</div>
...
<ul>
  <li>✨ Creating bugs since 1998</li>
  <li>📚 Currently learning: <strong>Express</strong>, <strong>Zod</strong>, <strong>Mongoose</strong></li>
  <li>🎯 Goals: shiny locks</li>
  <li>🎲 Fun fact: 1 + 1 = 11</li>
</ul>
